...
from blueprint.utils.utils import get_logger, run_shell_command
...
def commit_to_dvc(dvc_raw_data_folder: str, dvc_remote_name: str) -> None:
    ...
    DATA_UTILS_LOGGER.info(f"Updating the data version from v{current_version} to {next_version}...")
